...
class TrainersControllerTest < ActionController::TestCase
  ...
  test "should create trainer" do
    assert_difference('Trainer.count') do
      post :create, trainer: { birth: @trainer.birth, email: @trainer.email, name: @trainer.name, state: @trainer.state, surname: @trainer.surname }
    end
  ...
  test "should update trainer" do
    patch :update, id: @trainer, trainer: { birth: @trainer.birth, email: @trainer.email, name: @trainer.name, state: @trainer.state, surname: @trainer.surname }
    assert_redirected_to trainer_path(assigns(:trainer))
  end
